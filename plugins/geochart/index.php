<?php
/**
 * @brief REDCap plugin that generates a google geochart of data
 *
 * @file index.php
 * $Revision: 201 $
 * $Author: fmcclurg $
 * @author Fred R. McClurg, University of Iowa
 * $Date:: 2012-10-24 09:48:00 #$
 * $URL: https://srcvault.icts.uiowa.edu/repos/REDCap/REDCap/tags/geochart-1.0/index.php $
 * @ref $URL: https://srcvault.icts.uiowa.edu/repos/REDCap/REDCap/tags/geochart-1.0/index.php $
 */
...
?>
            <li>
               <a href="#geolocationTab">Geolocation
...
<?php
   ...
   {
?>
         <div id="geolocationTab">  <!-- Geolocation Tab -->
            <table>
               <tr>
